...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('header', null, []); ?> 
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                ...
                <?php echo e(__('Review Changes Requested')); ?>
        ...
        <aside id="sidebar" class="sidebar">
          ...
          <li class="nav-item">
              <a class="nav-link collapsed" href="<?php echo e(route('calendar.yourschedule')); ?>">
                        ...
                        <tbody>
                          <?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-danger btn-sm status-no" data-application-id="<?php echo e($application->id); ?>">Reject</button>&nbsp;
                                    <button class="btn btn-primary btn-sm status-yes" data-application-id="<?php echo e($application->id); ?>">Approve</button>
                                </td>
                            </tr>
            ...
            $(document).ready(function () {
                ...
                $('.status-no').on('click', function () {
                    ...
                    $(document).on('click', '#confirmBtn', function () {
                      ...
                      if ('<?php echo e($application->application_type); ?>' === 'On Call') {
                          url = "<?php echo e(route('updateReviewOnCall', ['id' => ':id'])); ?>";
                      } else {
                          url = "<?php echo e(route('updateReviewLeave', ['id' => ':id'])); ?>";
                      }
                ...
                $('.status-yes').on('click', function () {
                  ...
                  var rejectionReason = $('#rejectionReason').val();
                  if ('<?php echo e($application->application_type); ?>' === 'On Call') {
                      url = "<?php echo e(route('updateStatusOnCall', ['id' => ':id'])); ?>";
                  } else {
                      url = "<?php echo e(route('updateStatusLeave', ['id' => ':id'])); ?>";
                  }
                  url = url.replace(':id', id);
                  $.ajax({
                        url: url, 
...
</html><?php /**PATH E:\@UTM\FYP\HSS\resources\views/review.blade.php ENDPATH**/ ?>