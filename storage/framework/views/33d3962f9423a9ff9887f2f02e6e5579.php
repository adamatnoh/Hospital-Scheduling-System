...
<head>
    ...
    <title>HSS | Create On Call Schedule</title>
...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('header', null, []); ?> 
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                ...
                Create On Call Schedule (<?php echo e(Auth::user()->department); ?>)
            </h2>
         <?php $__env->endSlot(); ?>
            ...
            $(document).ready(function() {
                ...
                $('#calendar').fullCalendar({
                    ...
                    eventDrop: function(event) {
                        ...
                        $.ajax({
                            url:"<?php echo e(route('assign.update', '')); ?>" +'/'+ id,
                            type:"PATCH",
                            dataType:'json',
                    ...
                    eventClick: function(event){
                        ...
                        $('#saveBtn').click(function() {                            
                            $.ajax({
                                url:"<?php echo e(route('assign.delete', '')); ?>" +'/'+ id,
                                type:"DELETE",
                                dataType:'json',
                                success:function(response)
                                {
                ...
                function updateButtonState() {
                    ...
                    if (localStorage.getItem('finalizeState1') === 'true') {
                ...
                $('#generate').on('click', function() {
                    ...
                    $('#saveBtn2').on('click', function() {
                        ...
                        localStorage.setItem('finalizeState1', 'false');
                        updateButtonState();
                    });
                });
                ...
                $('#finalize').on('click', function() {
                    ...
                    if (finalizeBtn.text() === 'Finalize') {
                        ...
                        finalizeBtn.text('Edit Schedule');
                        finalizeBtn.addClass('btn-warning');
                        localStorage.setItem('finalizeState1', 'true');
                    } else {
                        generateBtn.prop('disabled', false);
                        finalizeBtn.text('Finalize');
                        finalizeBtn.removeClass('btn-warning');
...
</html><?php /**PATH E:\@UTM\FYP\HSS\resources\views/calendar/create-oncall.blade.php ENDPATH**/ ?>