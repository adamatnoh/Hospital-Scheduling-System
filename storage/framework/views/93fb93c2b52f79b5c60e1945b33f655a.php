...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('header', null, []); ?> 
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                ...
                Create Shift Schedule (<?php echo e(Auth::user()->department); ?>)
            </h2>
         <?php $__env->endSlot(); ?>
            ...
            $(document).ready(function() {
                ...
                $('#calendar').fullCalendar({
                    ...
                    eventDrop: function(event) {
                        ...
                        $.ajax({
                            url:"<?php echo e(route('shift.update', '')); ?>" +'/'+ id,
                            type:"PATCH",
                            dataType:'json',
                    ...
                    eventClick: function(event){
                        ...
                        $('#saveBtn').click(function() {                            
                            $.ajax({
                                url:"<?php echo e(route('shift.delete', '')); ?>" +'/'+ id,
                                type:"DELETE",
                                dataType:'json',
                                success:function(response)
                                {
...
</html><?php /**PATH E:\@UTM\FYP\HSS\resources\views/calendar/create-shift.blade.php ENDPATH**/ ?>