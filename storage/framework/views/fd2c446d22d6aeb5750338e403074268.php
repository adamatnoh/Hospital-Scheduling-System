...
<head>
    ...
    <title>HSS | Create Ward Schedule</title>
...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('header', null, []); ?> 
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                ...
                Create Ward Schedule (<?php echo e(Auth::user()->department); ?>)
            </h2>
         <?php $__env->endSlot(); ?>
            ...
            $(document).ready(function() {
                ...
                $('#calendar').fullCalendar({
                    ...
                    eventDrop: function(event) {
                        ...
                        $.ajax({
                            url:"<?php echo e(route('ward.update', '')); ?>" +'/'+ id,
                            type:"PATCH",
                            dataType:'json',
                    ...
                    eventClick: function(event){
                        ...
                        $('#saveBtn').click(function() {                            
                            $.ajax({
                                url:"<?php echo e(route('ward.delete', '')); ?>" +'/'+ id,
                                type:"DELETE",
                                dataType:'json',
                                success:function(response)
                                {
                ...
                function updateButtonState() {
                    ...
                    if (localStorage.getItem('finalizeState2') === 'true') {
                ...
                $('#generate').on('click', function() {
                    ...
                    $('#saveBtn2').on('click', function() {
                        ...
                        localStorage.setItem('finalizeState2', 'false');
                        updateButtonState();
                    });
                });
                ...
                $('#finalize').on('click', function() {
                    ...
                    if (finalizeBtn.text() === 'Finalize') {
                        ...
                        finalizeBtn.text('Edit Schedule');
                        finalizeBtn.addClass('btn-warning');
                        localStorage.setItem('finalizeState2', 'true');
                    } else {
                        generateBtn.prop('disabled', false);
                        finalizeBtn.text('Finalize');
                        finalizeBtn.removeClass('btn-warning');
...
</html><?php /**PATH E:\@UTM\FYP\HSS\resources\views/calendar/create-ward.blade.php ENDPATH**/ ?>